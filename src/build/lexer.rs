...
pub enum TokenInner {
    ...
    #[token("<", |_| Punctuation::Less)]
    #[token(">", |_| Punctuation::Greater)]
    #[token("=", |_| Punctuation::Equal)]
    #[token("==", |_| Punctuation::DoubleEqual)]
    #[token("&", |_| Punctuation::And)]
    #[token("&&", |_| Punctuation::DoubleAnd)]
    #[token("|", |_| Punctuation::Pipe)]
    #[token("||", |_| Punctuation::DoublePipe)]
